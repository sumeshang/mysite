...
RUN apt-get install -y python-dev python-setuptools git-core build-essential libmysqlclient-dev python-mysqldb nano vim
...
RUN /opt/ve/mysite/bin/pip install mysqlclient
EXPOSE 8000
